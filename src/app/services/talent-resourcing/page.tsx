          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Metasys facilitates businesses in <span style={{ color: '#00ffff', fontWeight: '600' }}>efficiently finding and onboarding new team members</span> in critical global locations. Organizations can leverage an unparalleled network of recruitment specialists to identify the perfect candidate tailored to their precise requirements, including industry, geographical region, and past expertise.
              </p>
            </div>
          </div>
        </section>
